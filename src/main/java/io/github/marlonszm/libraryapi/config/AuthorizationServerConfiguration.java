...
public class AuthorizationServerConfiguration {
    ...
    public TokenSettings tokenSettings() {
        return TokenSettings.builder()
                ...
                // access token: token utilizado nas requisições
    ...
    @Bean
    // JWK - JSON Web Key (chave criptográfica utilizada em processos de
    // autenticação e assinatura digital
    public JWKSource<SecurityContext> jwkSource() throws Exception{
        // metodo criptográfico assimétrico
        // chave pública = criptografar dados
        // chave privada = descriptografar dados (deve ser mantida em segredo)
